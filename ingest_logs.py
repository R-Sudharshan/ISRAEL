    ...
    for log in normalized_logs:
        try:
            ...
            for d in detections:
                ...
                # 3. Store Alert
                sql_alert = "INSERT INTO alerts (severity, detection_type, src_ip, timestamp, raw_log_reference, mitre_tactic, mitre_technique) VALUES (%s, %s, %s, %s, %s, %s, %s)"
                cursor.execute(sql_alert, (alert_data['severity'], alert_data['detection_type'], alert_data['src_ip'], alert_data['timestamp'], log_id, alert_data['mitre_tactic'], alert_data['mitre_technique']))
                alerts_generated += 1
